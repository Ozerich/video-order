        ...
        <div class="gallery-holder sound">
            ...
            <h3>Или загрузите свой mp3 файл:</h3>
							<span class="upload file">
									<input class="file-input-area" type="file" value="Browse..."/>
									<a class="button" href="#">ЗАГРУЗИТЬ</a>
							</span>
            <input class="filename" value="" readonly="readonly"></span>
        </div>
    </div>
    <div class="b">&nbsp;</div>
</div>

<div class="btn-next"><input type="submit" onclick="Video.ViewModel.active_tab(3); return false;" value="ДАЛЕЕ ШАГ 2"/></div>
